...
public:
	...
	// OMF unique serialisation functions
	void SerialiseModelData(Archiver *p_arhcive, OMFConverter::ModelInfo& model, Archiver::var_info& info);
...
// serialise std::vector containers
template <typename T>
